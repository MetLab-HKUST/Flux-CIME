...
# -----------------------------------------------------------------------------
# NOTICE: This script was custom-generated for /Workspace_II/shixm/CESM/my_cesm_sandbox/cime/scripts/historical.
#
#         DO NOT COPY to another case!
#
#         Use this script ONLY in /Workspace_II/shixm/CESM/my_cesm_sandbox/cime/scripts/historical.
# -----------------------------------------------------------------------------

set sourcemod_dir  = /Workspace_II/shixm/CESM/my_cesm_sandbox/cime/scripts/historical/SourceMods/src.cism/source_cism
set cism_confIOdir = /Workspace_II/shixm/CESM/my_cesm_sandbox/cime/scripts/historical/Buildconf/cismIOconf
